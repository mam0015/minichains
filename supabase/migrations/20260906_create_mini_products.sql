...
values
  ('music-note', 'Music Note Mini Keychain', 'A small beamed music-note charm. Simple and low-material — the lowest-cost pick in the range.', 'Small · single note charm', '≈ 15 min', 300, 'assets/images/music-note.jpg', 'assets/images/music-note.jpg', 'kevin.goetz', 'https://makerworld.com/en/models/1356704', true, false, 0, 1),
  ...
  ('basketball', 'Basket Ball Keychain', 'A flat basketball charm — sport-themed, stronger visual appeal than the basic entry charms.', 'Small · flat charm', '≈ 23 min', 300, 'assets/images/basketball.jpg', 'assets/images/basketball.jpg', 'fikuss30', 'https://makerworld.com/en/models/124469-basket-ball-keychain', true, false, 0, 4),
  ...
  ('cute-happy-cat', 'Cute Happy Cat Keychain', 'A cute-category charm with stronger perceived value than the most basic flat designs.', 'Small · flat charm', '≈ 24 min', 300, 'assets/images/cute-happy-cat.jpg', 'assets/images/cute-happy-cat.jpg', 'FC2M3D', 'https://makerworld.com/en/models/2298763-cute-happy-cat-keychain', true, false, 0, 8),
